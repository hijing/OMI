...
<script type='text/javascript'>
	function writeSave(){
		if(document.writeform.data.value == 'null'){
			alert("선택사항 필수!");
			document.writeform.data.focus();
			return false;
		}
		
		if(!document.writeform.local.value){
			alert("지역을 검색하여 넣어주세요.");
			document.writeform.local.focus();
			return false;
		}
	}
</script>
...
<center><b>글쓰기</b>
<br>
<form method="post" name="writeform" action="writePro.omi" onsubmit="return writeSave();">

<table border="1" cellspacing="0" cellpadding="0"  align="center" class="tcontent">
	<input type="hidden" name="num" value="${num }" />
	<input type="hidden" name="ref" value="${ref }" />
   <tr>
    <td  width="90"   align="center" class="tBack">이 름</td>
    <td  width="330">
       ${nickname }
  ...
  <tr>
    <td  width="90"   align="center" class="tBack">제 목</td>
    <td  width="330">
  ...
  <tr>
  	...
  	<td width="330">
  		<select name="data">
  		<option value=null selected>-데이터 선택-</option>
  ...
  <tr>
    ...
    <td>
     <input type="text" id="sample5_address" placeholder="주소를 검색하거나 지도를 클릭해주세요." name="local" size=30 readonly="true">
  ...
  <tr>
    <td  width="90"   align="center" class="tBack">내 용</td>
    <td  width="330" >
     <textarea name="content" style="width:100%;resize:none" rows=10 ></textarea> </td>
  </tr>
<tr>      
	<td colspan=2  align="center"> 
	위도 : <input type="text" readonly="true" name="x">
	경도 : <input type="text" readonly="true" name="y">
	</td>
</tr>
<tr>
	<td colspan=2 align="center">
  	...
  	<input type="button" value="목록보기" OnClick="window.location='list.omi'">
	</td>
</tr>
</table>   
</form>
		    ...
		    oncomplete: function(data) {
		        ...
		        geocoder.addressSearch(data.address, function(results, status) {
		            ...
		            if (status === daum.maps.services.Status.OK) {
		                ...
		                document.writeform.x.value=result.y;
		                document.writeform.y.value=result.x;
		                // 지도를 보여준다.
